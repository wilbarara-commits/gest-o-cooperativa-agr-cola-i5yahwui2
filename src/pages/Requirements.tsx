...
const MODULES: ModuleSpec[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'Nomes de Rota Livres: sem limitação ou validação de nomenclatura de rota, permitindo qualquer nome atribuído na planilha ou pela cooperativa.',
      'Limite de Rotas por Contrato (num_rotas_logisticas): o contrato define o número exato de rotas logísticas permitidas. Reduções só são aceitas se as rotas excedentes não possuírem pedidos vinculados.',
      'Roteamento por Contrato (Template Persistente): atribuição de pedidos pendentes às rotas logísticas, reaproveitada nos ciclos seguintes como modelo operacional até que seja modificada.',
      ...
      'Despacho da Rota Inteira: botão "Colocar em Rota" despacha a rota completa (todos os pedidos pendentes mudam para "Em Rota", gravando histórico na collection despachos).',
...
const DATA_MODEL = [
  ...
  'contratos (id, numero, numero_chamada, tipo, modalidade_pedido [individualizado/centralizado], num_rotas_logisticas, valor_total, status)',
