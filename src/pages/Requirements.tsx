...
const MODULES: ModuleSpec[] = [
  ...
  },
  {
    ...
    details: [
      'Roteamento Baseado em Escolas: Atribuição e sequenciamento operam diretamente sobre as escolas vinculadas ao contrato (contrato_escolas), não sobre pedidos individuais. O roteamento é estrutura duradoura do contrato, feita uma vez e reaproveitada em todos os ciclos.',
      ...
      'Painel de Escolas Sem Rota: Escolas vinculadas ao contrato sem rota aparecem em destaque na listagem de pendências. Pedidos dessas escolas permanecem com status Pendente sem rota e não bloqueiam o despacho das demais rotas.',
